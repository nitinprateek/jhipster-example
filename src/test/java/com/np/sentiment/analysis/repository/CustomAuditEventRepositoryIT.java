package com.np.sentiment.analysis.repository;

import com.np.sentiment.analysis.SentimentAnalysisApp;
import com.np.sentiment.analysis.config.Constants;
import com.np.sentiment.analysis.config.audit.AuditEventConverter;
import com.np.sentiment.analysis.domain.PersistentAuditEvent;
...
import static com.np.sentiment.analysis.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
