package com.np.sentiment.analysis.gateway.responserewriting;
...
import static com.np.sentiment.analysis.gateway.responserewriting.SwaggerBasePathRewritingFilter.gzipData;
